...
export default function Categories() {
    ...
    const deleteItems = async (itemsIds) => {
        try {
            ...
            await fetchApi(`/administration/categorie/${itemsIds}`, {
                method: 'DELETE',
            })

            dispacth(setToastAction({ severity: 'success', summary: 'Categorie supprimé', detail: "La categorie a été supprimé avec succès", life: 3000 }))
            fetchCategories()
            setSelectAll(false)
        ...
        confirmDialog({
            ...
            message: <div className="d-flex flex-column align-items-center">
                {inViewMenuItem ? <>
                    ...
                    <div className="font-bold text-center my-2">{inViewMenuItem?.DESCR_CATEGORIE}</div>
    ...
    const fetchCategories = useCallback(async () => {
        try {
            setLoading(true)
            const baseurl = `/administration/categorie?`
                ...
                <div className="content">
                    <div className="shadow rounded mt-3 pr-1 bg-white">
                        ...
                        >
                            ...
                            <Column field="DESCR_CATEGORIE" frozen header="Categorie" sortable body={item => {
                                return (
                                    <span>{item.DESCR_CATEGORIE}</span>
                                )
                            }} />
                                ...
                                const items = [
                                   {
                                        template: () => {
                                            return (
                                                <Link to={`/categorie/edit/${inViewMenuItem?.ID_CATEGORIE}`} className="p-menuitem-link">
                                    ...
                                    },
                                    {
                                        template: () => {
                                            return (
                                                <a href="#" className="p-menuitem-link text-danger" onClick={e => handleDeletePress(e, [inViewMenuItem.ID_CATEGORIE])}>
